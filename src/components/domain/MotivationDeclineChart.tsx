      ...
      <div className="flex-grow flex flex-col justify-between space-y-2">
        <div className="relative w-full h-64 sm:h-72 lg:h-80">
          ...
          >
            ...
            {/* Checkpoint Dots & Percentage Texts */}
            {/* Day 1 (x = 25) */}
            <g>
              <circle cx="25" cy="45" r="5" fill="#0F1E3D" />
              <text x="25" y="28" textAnchor="start" fill="#0F1E3D" fontSize="12" fontWeight="bold">
                95%
              </text>
            ...
            <g>
              ...
              <text x="175" y="123" textAnchor="middle" fill="#0F1E3D" fontSize="12" fontWeight="bold">
                45%
              </text>
            ...
            <g>
              ...
              <text x="325" y="181" textAnchor="middle" fill="#6B7280" fontSize="12" fontWeight="bold">
                25%
              </text>
            ...
            <g>
              ...
              <text x="475" y="193" textAnchor="end" fill="#B91C1C" fontSize="12" fontWeight="bold">
                15%
              </text>
